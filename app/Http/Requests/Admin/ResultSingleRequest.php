...
class ResultSingleRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'team1_logo' => 'required|image|mimes:jpeg,png,jpg,gif,tmp|max:2048',
            ...
            'team1_red_cards' => 'required|integer',
            'team2_name' => 'required|string',
            'team2_logo' => 'required|image|mimes:jpeg,png,jpg,gif,tmp|max:2048',
