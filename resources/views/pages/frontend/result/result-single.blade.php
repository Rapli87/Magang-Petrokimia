...
@section('content')
    ...
    <div class="rs-breadcrumbs sec-color">
        <img src="{{ asset('frontend/images/breadcrumbs/point-table.jpg') }}" alt="Breadcrubs" />
                ...
                <table>
                    <tr>
                        <th class="team-name stats1">
                            ...
                            <span>{!! nl2br(e($resultSingle->team1_scorers)) !!}</span>
                        </th>
                        ...
                        <th class="team-name stats2">
                            ...
                            <span>{!! nl2br(e($resultSingle->team2_scorers)) !!}</span>
                        </th>
                    </tr>
