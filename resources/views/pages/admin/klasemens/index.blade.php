                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Klasemens</a>
                                    </li>
                                </ol>
                            </div>
                            <h4 class="page-title">Klasemens </h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="table-responsive">
                                <div class="card-body">
                                    <table id="fixed-columns-datatable"
                                        ...
                                        <a href="{{ route('group-klasemens.create') }}" class="btn btn-primary mb-2">
                                        ...
                                        @foreach ($klasemens as $klasemen)
                                            @if ($klasemen->group !== $currentGroup)
                                                @if (!is_null($currentGroup))
                                                    </tbody>
                                    </table>
                                    @endif

                                    <h3>Group {{ $klasemen->group }}</h3>
                                    <table id="fixed-columns-datatable"
                                        class="table table-striped nowrap row-border order-column w-100">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('group-klasemens.edit', $klasemen->id) }}"
                                                        class="btn btn-warning">
                                                        <i class="ri-pencil-line text-light"></i>
                                                    </a>
                                                    <form action="{{ route('group-klasemens.destroy', $klasemen->id) }}"
