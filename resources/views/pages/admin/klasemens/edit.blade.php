                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select name="group"
                                                ...
                                                <option value=" A" {{ $klasemen->group == 'A' ? 'selected' : '' }}>Group
                                                    A</option>
                                                <option value=" B" {{ $klasemen->group == 'B' ? 'selected' : '' }}>Group
                                                    B</option>
                                                <option value=" C" {{ $klasemen->group == 'C' ? 'selected' : '' }}>Group
                                                    C</option>
                                                <option value=" D" {{ $klasemen->group == 'D' ? 'selected' : '' }}>Group
                                                    D</option>
                                                <option value=" E" {{ $klasemen->group == 'E' ? 'selected' : '' }}>Group
                                                    E</option>
                                                <option value=" F" {{ $klasemen->group == 'F' ? 'selected' : '' }}>Group
                                                    F</option>
                                                <option value=" G" {{ $klasemen->group == 'G' ? 'selected' : '' }}>Group
                                                    G</option>
                                                <option value=" H" {{ $klasemen->group == 'H' ? 'selected' : '' }}>Group
                                                    H</option>
                                            </select>
                                            @error('group')
