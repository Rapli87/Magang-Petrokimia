                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data Jurnalis</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="p-4 my-auto">
                                <h4 class="fs-20">Form Pendaftaran PGFC Jurnalis</h4>
                                <p class="text-muted mb-3">Form Pendaftaran Jurnalis di bawah ini </p>
                                        ...
                                        <div id="basicwizard">
                                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                                <li class="nav-item">
                                                    <a href="#basictab1" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Form Jurnalis</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab2" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Tabel Jurnalis</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab3" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">View Jurnalis</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content b-0 mb-0">
                                             ...
                                             <form action="{{ route('Jurnalis.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label class="col-md-3 col-form-label" for="ktp">ktp</label>
                                                                <div class="col-md-9">
                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="d-flex">
                        ...
                        <div class="info">
                            ...
                            @if(isset($data->nama))
                                <p class="text-muted fs-15">{{ $data->nama }}</p>
                            @else
                                <p class="text-muted fs-15">Data not found</p>
                            @endif
                        
                            <h5 class="fs-18 my-1">Hp:</h5>
                            @if(isset($data->hp))
                                <p class="text-muted fs-15">{{ $data->hp }}</p>
                            @else
                                <p class="text-muted fs-15">Data not found</p>
                            @endif
                            ...
                            @if(isset($data->alamat))
                                <p class="text-muted fs-15">{{ $data->alamat }}</p>
                            @else
                                <p class="text-muted fs-15">Data not found</p>
                            @endif
                            ...
                            @if(isset($data->foto))
                                <p class="text-muted fs-15">{{ $data->foto }}</p>
                            @else
                                <p class="text-muted fs-15">Data not found</p>
                            @endif
                            ...
                            @if(isset($data->ktp))
                                <p class="text-muted fs-15">{{ $data->ktp }}</p>
                            @else
                                <p class="text-muted fs-15">Data not found</p>
                            @endif
                        </div>
