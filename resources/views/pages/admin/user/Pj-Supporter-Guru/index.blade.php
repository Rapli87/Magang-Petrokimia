                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data Pj Supporter Guru</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="p-4 my-auto">
                                <h4 class="fs-20">Form Pendaftaran PGFC Pj Supporter Guru</h4>
                                <p class="text-muted mb-3">Form Pendaftaran Pj Supporter Guru di bawah ini </p>
                                            ...
                                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                                <li class="nav-item">
                                                    <a href="#basictab1" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Form Pj Supporter Guru</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab2" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Tabel Pj Supporter Guru</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab3" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">View Pj Supporter Guru</span>
                                                    </a>
                                                </li>
                                            </ul>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mt-0">Data Tabel Supporter Guru</h5>
                <p class="sub-header font-13">List Data Tabel Pj Supporter Guru di bawah ini</p>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="{{ route('Pj-Supporter-Guru.delete', ['id' => $data->id]) }}">Hapus</a>
                                            </li>

                                            <li><a class="dropdown-item"
                                                href="{{ route('Pj-Supporter-Guru.edit', ['id' => $data->id]) }}">Edit</a>
                                        </li>
