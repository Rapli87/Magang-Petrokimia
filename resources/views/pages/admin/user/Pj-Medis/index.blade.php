                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data Pj Medis</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="p-4 my-auto">
                                <h4 class="fs-20">Form Pendaftaran PGFC Pj Medis</h4>
                                <p class="text-muted mb-3">Form Pendaftaran Pj Medis di bawah ini </p>
                                        ...
                                        <div id="basicwizard">
                                            <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                                <li class="nav-item">
                                                    <a href="#basictab1" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Form Pj Medis</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab2" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">Tabel Pj Medis</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#basictab3" data-bs-toggle="tab" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline">View Pj Medis</span>
                                                    </a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content b-0 mb-0">
                                             ...
                                             <form action="{{ route('Pj-Medis.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="row mb-3">
