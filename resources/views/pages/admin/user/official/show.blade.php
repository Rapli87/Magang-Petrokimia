                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Data Official</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Detail Data Official</a></li>
                            </ol>
                        </div>
                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="d-flex">
                        ...
                        <div class="info">
                            ...
                            <p class="text-muted fs-15">{{ $official->nama }}</p>

                             <h5 class="fs-18 my-1">Hp:</h5>
                            <p class="text-muted fs-15">{{ $official->hp }}</p>

                            <h5 class="fs-18 my-1">Alamat:</h5>
                            <p class="text-muted fs-15">{{ $official->alamat }}</p>

                            <h5 class="fs-18 my-1">Foto:</h5>
                            <p class="text-muted fs-15">{{ $official->foto }}</p>

                            <h5 class="fs-18 my-1">Ktp:</h5>
                            <p class="text-muted fs-15">{{ $official->ktp }}</p>
