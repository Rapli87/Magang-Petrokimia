                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data Official</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="p-4 my-auto">
                                <h4 class="fs-20">Tambah Data Official</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="mt-0">Data Tabel Official</h5>
                                    <p class="sub-header font-13">List Data Tabel Official di bawah ini</p>
                                    <div class="table-responsive">
                                        <table class="table table-centered mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($Official->sortBy('id') as $data)
                                                    <tr class="text-center">
                                                        <td>{{ $data->id }}</td>
                                                        <td>{{ $data->nama }}</td>
                                                        <td>{{ $data->hp }}</td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('Official.show', ['id' => $data->id]) }}">View</a>
                                                                    </li>
            
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('Official.delete', ['id' => $data->id]) }}">Hapus</a>
                                                                    </li>

                                                                    <li><a class="dropdown-item"
                                                                        href="{{ route('Official.edit', ['id' => $data->id]) }}">Edit</a>
                                                                </li>
