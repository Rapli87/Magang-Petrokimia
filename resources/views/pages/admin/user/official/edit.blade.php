...
@section('title', 'Edit Data Official | PGFC User')
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Data Official</a>
                                    </li>
                                </ol>
                            </div>
                            <h4 class="page-title">Edit Data Official </h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('Official.update', $data->id) }}" method="POST"enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
