                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Data Tim</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Detail Data Tim</a></li>
                            </ol>
                        </div>
                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="d-flex">
                        ...
                        <div class="info">
                            ...
                            <p class="text-muted fs-15">{{ $pjtim->nama }}</p>

                             <h5 class="fs-18 my-1">Hp:</h5>
                            <p class="text-muted fs-15">{{ $pjtim->hp }}</p>
                            ...
                            <p class="text-muted fs-15">{{ $pjtim->ktp }}</p>
