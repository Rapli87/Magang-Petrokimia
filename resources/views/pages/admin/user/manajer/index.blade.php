                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Data Manajer</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="p-4 my-auto">
                                <h4 class="fs-20">Tambah Data Manajer</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($manajer->sortBy('id') as $data)
                                                    <tr class="text-center">
                                                        <td>{{ $data->id }}</td>
                                                        <td>{{ $data->nama }}</td>
                                                        <td>{{ $data->hp }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('manajer.delete', ['id' => $data->id]) }}">Hapus</a>
                                                                    </li>

                                                                    <li><a class="dropdown-item"
                                                                        href="{{ route('manajer.edit', ['id' => $data->id]) }}">Edit</a>
                                                                </li>
