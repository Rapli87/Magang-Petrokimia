                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Data Pelatih</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Detail Data Pelatih</a></li>
                            </ol>
                        </div>
                ...
                <div class="d-flex align-items-start justify-content-between">
                    <div class="d-flex">
                        ...
                        <div class="info">
                            ...
                            <p class="text-muted fs-15">{{ $pelatih->nama }}</p>

                             <h5 class="fs-18 my-1">Hp:</h5>
                            <p class="text-muted fs-15">{{ $pelatih->hp }}</p>

                            <h5 class="fs-18 my-1">Alamat:</h5>
                            <p class="text-muted fs-15">{{ $pelatih->alamat }}</p>

                            <h5 class="fs-18 my-1">Foto:</h5>
                            <p class="text-muted fs-15">{{ $pelatih->foto }}</p>

                            <h5 class="fs-18 my-1">Ktp:</h5>
                            <p class="text-muted fs-15">{{ $pelatih->ktp }}</p>
