...
@section('title', 'Gallery | PGFC Admin')
@push('addon-style')
    <!-- Datatables css -->
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Gallery</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="table-responsive">
                                <div class="card-body">
                                    <table id="fixed-columns-datatable"
                                        ...
                                        <a href="{{ route('galleries.create') }}" class="btn btn-primary mb-2">
                                        ...
                                        <tbody>
                                            @foreach ($galleries as $gallery)
                                                <tr>
                                                    ...
                                                    <td>{{ $gallery->title }}</td>
                                                    <td>
                                                        <img src="{{ url($gallery->image) }}" alt="{{ $gallery->title }}" width="100px">
                                                    </td>
                                                    <td>
